...
public class BirdUserServiceMain {

	private static final Log logger = LogFactory.getLog(BirdUserServiceMain.class);

	public static void main(String[] args) {
		try {
			ApplicationContext context = SpringApplication.run(BirdUserServiceMain.class, args);
			// 在使用注册中心时要主动调用下面代码
