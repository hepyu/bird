...
public class BirdLBSServiceMain {

	private static final Log logger = LogFactory.getLog(BirdLBSServiceMain.class);

	public static void main(String[] args) {
		try {
			ApplicationContext context = SpringApplication.run(BirdLBSServiceMain.class, args);
			// 在使用注册中心时要主动调用下面代码
